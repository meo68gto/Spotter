...
export default function OrganizerLayout({ children }: OrganizerLayoutProps) {
  ...
  const navLinkClass = (path: string) => {
    const base = "flex items-center px-4 py-2 rounded-lg transition-colors";
          ...
          <ul className="space-y-2">
            ...
            <li>
              <Link
                ...
                className={navLinkClass("/organizer/events")}
              >
                <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <li>
              <Link
                ...
                className={navLinkClass("/organizer/members")}
              >
                <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <li>
              <Link
                ...
                className={navLinkClass("/organizer/financials")}
              >
                <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <li>
              <Link
                ...
                className={navLinkClass("/organizer/invoices")}
              >
                <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <li>
              <Link
                ...
                className={navLinkClass("/organizer/waitlist")}
              >
                <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <li>
              <Link
                ...
                className={navLinkClass("/organizer/contests")}
              >
                <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <li>
              <Link
                ...
                className={navLinkClass("/organizer/sponsors")}
              >
                <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <li>
              <Link
                ...
                className={navLinkClass("/organizer/analytics")}
              >
                <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <li>
              <Link
                ...
                className={navLinkClass("/organizer/settings")}
              >
                <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
